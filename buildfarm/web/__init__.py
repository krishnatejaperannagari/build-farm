...
#        yield "    <link rel='stylesheet' href='http://www.samba.org/samba/style/common.css' type='text/css' media='all'/>"
        ...
        yield util.UrlLoad("http://www.samba.org/samba/menu_think_samba_closed.html")
        yield util.UrlLoad("http://www.samba.org/samba/menu_get_samba_closed.html")
        yield util.UrlLoad("http://www.samba.org/samba/menu_learn_samba_closed.html")
        yield util.UrlLoad("http://www.samba.org/samba/menu_talk_samba_closed.html")
        yield util.UrlLoad("http://www.samba.org/samba/menu_hack_samba_closed.html")
        yield util.UrlLoad("http://www.samba.org/samba/menu_contact_samba_closed.html")
        yield util.FileLoad(os.path.join(webdir, "bannernav2.html"))
        yield "".join(lines)
        yield util.FileLoad(os.path.join(webdir, "sitemap1.html"))
        yield util.UrlLoad("http://www.samba.org/samba/menu_think_samba_raw.html")
        yield util.FileLoad(os.path.join(webdir, "sitemap2.html"))
        yield util.UrlLoad("http://www.samba.org/samba/menu_get_samba_raw.html")
        yield util.FileLoad(os.path.join(webdir, "sitemap3.html"))
        yield util.UrlLoad("http://www.samba.org/samba/menu_learn_samba_raw.html")
        yield util.FileLoad(os.path.join(webdir, "sitemap4.html"))
        yield util.UrlLoad("http://www.samba.org/samba/menu_talk_samba_raw.html")
        yield util.FileLoad(os.path.join(webdir, "sitemap5.html"))
        yield util.UrlLoad("http://www.samba.org/samba/menu_hack_samba_raw.html")
        yield util.FileLoad(os.path.join(webdir, "sitemap6.html"))
        yield util.UrlLoad("http://www.samba.org/samba/menu_contact_samba_raw.html")
        yield util.FileLoad(os.path.join(webdir, "sitemap7.html"))
        yield util.FileLoad(os.path.join(webdir, "right1.html"))
        yield util.UrlLoad("http://www.samba.org/samba/latest_stable_release.html")
